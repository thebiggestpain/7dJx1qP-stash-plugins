...
export function waitForElementId(elementId, callBack, time) {
...
export function waitForElementClass(elementId, callBack, time) {
    time = (typeof time !== 'undefined') ? time : 100;
    window.setTimeout(() => {
...
export function waitForElementByXpath(xpath, callBack, time) {
    time = (typeof time !== 'undefined') ? time : 100;
    window.setTimeout(() => {
...
export function waitForElementsByXpath(xpath, callBack, time) {
    time = (typeof time !== 'undefined') ? time : 100;
    window.setTimeout(() => {
...
export function updateTextInput(element, value) {
...
export function sortElementChildren(node) {
